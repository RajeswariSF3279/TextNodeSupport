...
window.sfBlazor.DropDownList = function () {
  ...
  function () {
    ...
    SfDropDownList.prototype.setSearchBoxPosition = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.popupObj.element.querySelector('.e-ddl-footer')) && !sf.base.isNullOrUndefined(this.popupObj.element.querySelector('.e-ddl-header'))) {
