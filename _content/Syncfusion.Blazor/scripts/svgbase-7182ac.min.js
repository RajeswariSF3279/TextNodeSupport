...
window.sf.svgbase = function (exports) {
  ...
  function findDirection(rX, rY, rect, arrowLocation, arrowPadding, top, bottom, left, tipX, tipY) {
    ...
    if (top) {
      ...
      direction = direction.concat(' L' + ' ' + tipX + ' ' + (arrowLocation.y + startX));
  ...
  function (_super) {
    ...
    Tooltip.prototype.tooltipLocation = function (bounds, symbolLocation, arrowLocation, tipLocation) {
      ...
      if (!this.inverted) {
        ...
        if (!withInAreaBounds(location.x, location.y, new Rect(bounds.x, bounds.y, bounds.width, bounds.height))) {
          this.inverted = !this.inverted;
          this.revert = true;
