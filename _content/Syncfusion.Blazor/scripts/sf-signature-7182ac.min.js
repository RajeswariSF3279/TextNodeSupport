...
window.sfBlazor.Signature = function () {
  ...
  function (_super) {
     ...
     *
     * @private
     * @param {string} type - Specifies the type of the image format.
     * @returns {string}.
     */
    ...
    SignatureBase.prototype.getSignature = function (type) {
      if (type === 'jpg') {
        return this.canvasContext.canvas.toDataURL('image/jpeg');
      } else {
  ...
  var Signature = {
    ...
    getSignature: function getSignature(element, type) {
      return SignatureBase.prototype.getSignature(type);
    },
